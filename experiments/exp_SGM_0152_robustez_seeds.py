#!/usr/bin/env python3
"""exp_SGM_0152 — LIBERTAD + CONOCIMIENTO DEL MUNDO + MUNDO PERSISTENTE + 30min.
...
print("="*70)
print(" exp_SGM_0152 — ROBUSTEZ: cadena de subsistencia en MULTIPLES seeds + vidas")
print("="*70)
TODAS_SEEDS = []
...
out=os.path.expanduser("~/vaults/vega-vault/NOUS/DSCN-G/EXPERIMENTS/SGM/"
                       "results/results_exp_SGM_0152_robustez_seeds.json")
os.makedirs(os.path.dirname(out),exist_ok=True)
json.dump({
    "experiment_id":"exp_SGM_0152","experiment_name":"robustez_multi_seed_cadena_subsistencia",
    ...
    "script":"experiments/exp_SGM_0152_robustez_seeds.py",
    "results_file":"results/results_exp_SGM_0152_robustez_seeds.json",
