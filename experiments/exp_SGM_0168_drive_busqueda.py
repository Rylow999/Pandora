#!/usr/bin/env python3
"""exp_SGM_0168 — DIAGNOSTICO del crafteo (un solo grafo, instrumentado).
...
print("="*70)
print(" exp_SGM_0168 — SEEKING food drive: el agente vuelve a comer/craftear?")
print("="*70)
...
print("  (objetivo: confirmar que el SEEKING food drive restaura subsistencia)")
...
json.dump({
  ...
  "phase":"Fase 9 - SEEKING food drive: restaurar la subsistencia (comer/craftear)",
  "date":"2026-08-15",
  "mision":"verificar que el SEEKING food drive (moverse a buscar alimento bajo hambre real y "
           "nada enfrente) restaura la subsistencia emergente: comer vacas y craftear.",
  ...
  "result":{"diag":diag,"logros":logros,"pasos":total,
    ...
    "script":"experiments/exp_SGM_0168_drive_busqueda.py",
    "results_file":"results/results_exp_SGM_0168_drive_busqueda_comida.json",
