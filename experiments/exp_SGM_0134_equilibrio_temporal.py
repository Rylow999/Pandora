#!/usr/bin/env python3
"""exp_SGM_0134 — INSTINTO DE INTERACCION unificado (hambre + defensa via 'do').
...
MECANISMO (core 0134): la pulsion a 'do' sube = max(hambre_real, amenaza) * fuerza,
...
def correr(seed, max_p=600):
    ...
    for step in range(max_p):
        ...
        # (0134: equilibrio temporal). Un enemigo LEJANO es amenaza baja -> el hambre puede
        ...
        # 0134 RE-ENCARE: objetivo dominante segun necesidad. Si hay amenaza, prioriza
...
print("=" * 70)
print(" exp_SGM_0134 — Equilibrio temporal: comer en calma, pelear bajo amenaza inminente")
print("=" * 70)
for seed in [42, 7, 99]:
...
out = os.path.expanduser("~/vaults/vega-vault/NOUS/DSCN-G/EXPERIMENTS/SGM/"
                         "results/results_exp_SGM_0134_equilibrio_temporal.json")
os.makedirs(os.path.dirname(out), exist_ok=True)
json.dump({
    "experiment_id": "exp_SGM_0134",
    "experiment_name": "equilibrio_temporal_hambre_defensa",
    ...
    "script": "experiments/exp_SGM_0134_equilibrio_temporal.py",
    "results_file": "results/results_exp_SGM_0134_equilibrio_temporal.json",
    "variant_of": "exp_SGM_0133",
