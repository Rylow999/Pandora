#!/usr/bin/env python3
"""exp_SGM_0151 — LIBERTAD + CONOCIMIENTO DEL MUNDO + MUNDO PERSISTENTE + 30min.
...
print("="*70)
print(" exp_SGM_0151 — LIBERTAD + CONOCIMIENTO MUNDO + MUNDO PERSISTENTE + vidas largas")
print("="*70)
for seed in [42]:
...
out=os.path.expanduser("~/vaults/vega-vault/NOUS/DSCN-G/EXPERIMENTS/SGM/"
                       "results/results_exp_SGM_0151_mundo_persistente.json")
os.makedirs(os.path.dirname(out),exist_ok=True)
json.dump({
    "experiment_id":"exp_SGM_0151","experiment_name":"libertad_conocimiento_mundo_persistente",
    "phase":"Fase 8 - libertad + conocimiento del mundo + mundo persistente + vidas largas",
    "date":"2026-08-11",
    "mision":"Luciano: con libertad + conocimiento + funciones + varias vidas + 30 min, el "
             "agente completa la cadena por su cuenta. La pieza nueva: MUNDO PERSISTENTE entre "
             "vidas (la mesa colocada no se pierde).",
    "config":{"D":D,"N_NODES":N_NODES,"n_lives":8,"max_pasos_vida":2000,"seed":42,
              "mundo_persistente":True,"conocimiento_mundo":"recetas make/place como repertorio"},
    "result":{"resumen_lives_escrito_en_stdout":"vidas en stdout, logros_y_pasos bii"},
    "script":"experiments/exp_SGM_0151_mundo_persistente.py",
    "results_file":"results/results_exp_SGM_0151_mundo_persistente.json",
