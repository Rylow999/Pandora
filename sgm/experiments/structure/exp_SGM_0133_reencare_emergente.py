#!/usr/bin/env python3
"""exp_SGM_0133 — INSTINTO DE INTERACCION unificado (hambre + defensa via 'do').
...
MECANISMO (core 0133): la pulsion a 'do' sube = max(hambre_real, amenaza) * fuerza,
...
def correr(seed, max_p=600):
    ...
    for step in range(max_p):
        ...
        # 0133 RE-ENCARE: objetivo dominante segun necesidad. Si hay amenaza, prioriza
...
print("=" * 70)
print(" exp_SGM_0133 — Re-encare emergente: orientarse al objetivo antes de interactuar")
print("=" * 70)
for seed in [42, 7, 99]:
...
out = os.path.expanduser("~/vaults/vega-vault/NOUS/DSCN-G/EXPERIMENTS/SGM/"
                         "results/results_exp_SGM_0133_reencare_emergente.json")
os.makedirs(os.path.dirname(out), exist_ok=True)
json.dump({
    "experiment_id": "exp_SGM_0133",
    ...
    "script": "experiments/exp_SGM_0133_reencare_emergente.py",
    "results_file": "results/results_exp_SGM_0133_reencare_emergente.json",
