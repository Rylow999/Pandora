#!/usr/bin/env python3
"""exp_SGM_0128 — Dinamica NATIVA de Crafter completa + Hebbian fix + Kuramoto.
...
def instinto_eat(agent, usar_consolidacion, food_nivel=None):
    """Compuerta de habituacion + anclaje a HAMBRE REAL de food (0128).
...
print("=" * 70)
print(" exp_SGM_0128 — DRIVE NOOP (SEEEKING anti-noop) - vida nativa")
print("=" * 70)
...
out = os.path.expanduser("~/vaults/vega-vault/NOUS/DSCN-G/EXPERIMENTS/SGM/"
                         "results/results_exp_SGM_0128_drive_noop.json")
os.makedirs(os.path.dirname(out), exist_ok=True)
json.dump({
    "experiment_id": "exp_SGM_0128",
    "experiment_name": "drive_noop_seeking",
    "phase": "Fase 8 - DRIVE NOOP (SEEEKING anti-noop) - vida nativa",
    "date": "2026-08-11",
    ...
    "script": "experiments/exp_SGM_0128_drive_noop.py",
    "results_file": "results/results_exp_SGM_0128_drive_noop.json",
    "variant_of": "exp_SGM_0127",
